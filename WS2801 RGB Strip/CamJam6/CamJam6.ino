...
void loop() {
  drawShapes(STARTSquare, ENDSquare, Color(255, 0, 0), Color(0, 0, 255), 500);
  delay(1000);

  scrollStringLeft(" Welcome to CamJam 6 ", Color(0, 0, 255), Color(0, 0, 0), 500);
  delay(1000);

  drawShapes(STARTVBar, ENDVBar, Color(255, 0, 0), Color(0, 255, 0), 100);
  delay(1000);

  drawStringFade(" Next CamJam - 5 July ", Color(255, 0, 0), Color(0, 0, 0), 10, 50, 500);
  delay(1000);
